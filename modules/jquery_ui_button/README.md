...
jQuery UI button library for any themes and modules that require it.

  - jQuery UI [Button documentation](https://jqueryui.com/button/)
  - jQuery UI [Button API documentation](https://api.jqueryui.com/button/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.button` to `jquery_ui_button/button`
